...
<header>
    <div class="container-fluid">
        ...
        <div class="row segundonav">
            <nav class="navbar">
                <div class="col-lg-1 col-1"><li><a class="linksegundonav" href="index.php?pagina=inicio">Inicio</a></li></div>
                ...
                ?>
                <div class="col-lg-4 col-4 d-none d-lg-block"><li></li></div>
                <div class="col-lg-2 col-3"><li><a class="linksegundonav" href="#footer">Contáctanos</a></li></div>
                <div class="col-lg-2 col-3 scroll"><li><a class="linksegundonav" href="index.php?pagina=Quienes_Somos"> ¿Qué es VETCO?</a></li></div>
            </nav >
        </div>
    </div>
</header>
...
<?php
  ...
  {
    if($_GET["pagina"]=="inicio" || $_GET["pagina"]=="buscar" || 
